                    ...
                    <div class="card card-outline card-warning">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" name="title" class="form-control form-control-lg @error('title') is-invalid @enderror" value="{{ old('title', $article->title) }}" placeholder="Masukkan judul artikel..." required>
                                @error('title')
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="content" class="form-control" id="content-editor" required>{{ old('content', $article->content) }}</textarea>
                                @error('content')
                     ...
                     <div class="card card-outline card-secondary">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                @if($article->image)
                                    <div class="mb-2 img-preview-container">
                                        <img src="{{ asset('storage/'.$article->image) }}" class="img-fluid rounded border p-1" style="max-height: 150px; width: 100%; object-fit: cover;">
                                    </div>
                                @endif
